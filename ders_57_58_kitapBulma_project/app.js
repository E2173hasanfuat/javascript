let kitap1 = { isim: "Her seyi dusurme", yazar: "anne bogel", fiyat: 25,raf:4.5.RAF };
let kitap2 = { isim: "normal", yazar: "mehmet", fiyat: 55,raf:3.5.RAF };
let kitap3 = { isim: "High", yazar: "haluk", fiyat: 65,raf:2.5.RAF };
let kitap4 = { isim: "Man", yazar: "can", fiyat: 15,raf:1.5.RAF };
let kitap5 = { isim: "Low", yazar: "atak", fiyat: 85,raf:5.5.RAF };
...
let kitapismi =prompt("lutfen isim giriniz");
